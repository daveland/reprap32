...
#define X_MIN_PIN       Pin(AVR32_PIN_PB10) //Pin(PortB,6)
// The X maximum endstop pin (active high)
#define X_MAX_PIN       Pin(AVR32_PIN_PB11) //Pin(PortB,5)
...
#define Y_MIN_PIN       Pin(AVR32_PIN_PB08) //Pin(PortB,4)
// The Y maximum endstop pin (active high)
#define Y_MAX_PIN       Pin(AVR32_PIN_PA09) //Pin(PortH,6)
...
#define Z_MIN_PIN       Pin(AVR32_PIN_PA21) //Pin(PortH,5)
// The Z maximum endstop pin (active high)
#define Z_MAX_PIN       Pin(AVR32_PIN_PA22) //Pin(PortH,4)
