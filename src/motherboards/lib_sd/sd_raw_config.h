...
/* defines for customisation of sd/mmc port access */
    ...
    #define configure_pin_mosi()  Pin(AVR_PIN_PA16).setDirection(true)
    #define configure_pin_sck() Pin(AVR_PIN_PA16).setDirection(true)
    #define configure_pin_ss() Pin(AVR_PIN_PA16).setDirection(true)
    #define configure_pin_miso() Pin(AVR_PIN_PA16).setDirection(true)

    #define select_card() 0
    #define unselect_card() 0
#else
